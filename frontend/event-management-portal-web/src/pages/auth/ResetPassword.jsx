  ...
  <div className="space-y-1.5">
    ...
    <div className="relative">
      <input
        ...
        className={`w-full px-4 py-2.5 pr-11 border rounded-lg text-sm outline-none transition-all placeholder:text-gray-300 ${error
      ...
      <div className="min-h-screen bg-[#eef2f7] flex flex-col items-center justify-center p-4 font-sans">
        ...
        <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] overflow-hidden">
          ...
          <div className="px-8 py-7 space-y-5">
            {status.message && (
              <div
                className={`flex items-start gap-3 p-4 rounded-lg text-sm border ${status.type === "success"
            ...
            {status.type !== "success" && token && (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-3 bg-[#1a3a6b] text-white rounded-lg font-semibold text-sm transition-all flex items-center justify-center gap-2 mt-2 ${loading
