...
public class EventRegistrationResponse {
    ...
    public static EventRegistrationResponse from(EventRegistration registration,
        ...
        return EventRegistrationResponse.builder()
                ...
                .qrTokenExpiry(
                        registration.getQrTokenExpiry() != null ? registration.getQrTokenExpiry().toString() : null)
                .checkedIn(registration.isCheckedIn())
                .checkInTime(registration.getCheckInTime() != null ? registration.getCheckInTime().toString() : null)
                .eventStartTime(registration.getEvent() != null && registration.getEvent().getStartTime() != null
                        ? registration.getEvent().getStartTime().toString()
                        : null)
                .eventEndTime(registration.getEvent() != null && registration.getEvent().getEndTime() != null
                        ? registration.getEvent().getEndTime().toString()
                        : null)
                .eventLocation(registration.getEvent() != null ? registration.getEvent().getLocation() : null)
                .profile(profile)
