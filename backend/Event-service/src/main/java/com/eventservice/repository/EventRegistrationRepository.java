...
public interface EventRegistrationRepository extends JpaRepository<EventRegistration, String> {
    ...
    Optional<EventRegistration> findWithLockById(@Param("id") String id);

    @Lock(LockModeType.PESSIMISTIC_WRITE)
    @Query("SELECT r FROM EventRegistration r WHERE r.event.id = :eventId AND r.participantAccountId = :userId")
    ...
    Optional<EventRegistration> findFirstByEventIdAndParticipantAccountId(String eventId, String participantAccountId);
