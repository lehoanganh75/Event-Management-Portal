...
const RegisterPage = () => {
  ...
  const validateStep2 = () => {
    ...
    if (!formData.username.trim()) {
      newErrors.username = userType === "STUDENT" ? "MSSV không được để trống" : userType === "LECTURER" ? "MSGV không được để trống" : "Tên đăng nhập không được để trống";
    }
        ...
        >
          ...
          {step === 2 && (
            <div className="space-y-5">
              ...
              <InputField 
                id="username" 
                label={userType === "STUDENT" ? "MSSV" : userType === "LECTURER" ? "MSGV" : "Tên đăng nhập"} 
                value={formData.username} 
                error={errors.username}
                placeholder={userType === "STUDENT" ? "Nhập MSSV" : userType === "LECTURER" ? "Nhập MSGV" : "Nhập tên đăng nhập"} 
