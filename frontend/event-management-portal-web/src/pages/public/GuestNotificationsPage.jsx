    ...
    >
      ...
      <div className="flex gap-4">
        <div className="flex-shrink-0 hidden sm:block">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isEmergency ? 'bg-red-50 text-red-500' : 'bg-slate-50 text-slate-400'
            }`}>
        ...
        <div className="flex-1 min-w-0 pr-6">
          <div className="flex items-center gap-2 mb-1">
            <span className={`text-[10px] font-bold uppercase tracking-wider ${isEmergency ? 'text-red-500' : 'text-blue-500'
              }`}>
                ...
                <div className="flex bg-slate-100 p-1 rounded-xl w-fit">
                  {['ALL', 'NEWS', 'EMERGENCY'].map(cat => (
                    <button
                      ...
                      className={`px-4 py-1.5 rounded-lg text-[11px] font-bold transition-all ${filter === cat
