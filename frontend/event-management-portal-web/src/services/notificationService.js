...
const BASE_URL = (import.meta.env.VITE_API_BASE_URL || 'https://fitiuh-events.io.vn') + '/notification/notifications';
const IDENTITY_BASE_URL = (import.meta.env.VITE_API_BASE_URL || 'https://fitiuh-events.io.vn') + '/identity';
