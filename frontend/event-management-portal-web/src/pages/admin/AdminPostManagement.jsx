        ...
        <div className="flex justify-center gap-2 mt-8">
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1).map((num) => (
            <button
              ...
              className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-semibold transition-all ${currentPage === num
                ? "bg-blue-600 text-white shadow-md shadow-blue-100"
                : "bg-white border border-gray-200 text-slate-600 hover:border-blue-300 hover:bg-gray-50"
                }`}
            >
              {num}
            </button>
